          ...
          <div class="col d-flex">
              ...
              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                  <div class="modal-header pb-2 pt-2">
                    <h1 class="modal-title fs-5" id="modalProfilePicture">Foto de perfil: </h1>
                  ...
                  <div class="modal-body row g-3">
                    <form action="#" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-12 d-flex align-items-center justify-content-end mt-3">
                        <button type="submit" name="changePicture" class="btn btn-secondary">Enviar</button>
                      </div>
                    </form>
                  </div>
                </div>
            ...
            <div>
              <form action="#" method="post">
                ...
                <input type="text" name="tlf" id="tlf" required class="form-control" value="<?php echo $cliente['tlf2'] ?>">

                <!-- Password -->
                <div class="col-12 d-flex align-items-center justify-content-center">
                  <button type="button" class="btn btn-sm btn-outline-secondary rounded mt-4" data-bs-toggle="modal" data-bs-target="#modPass">Cambiar Contraseña</button>
                </div>
              </form>
                          ...
                          <div class="modal-body row g-3">
                              <form action="#" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="col-2 d-flex align-items-center justify-content-end mt-2_5rem">
                                      <button type="submit" name="modPass" value="" class="btn btn-secondary">Enviar</button>
                                  </div>
                              </form>
                          </div>
                      </div>
