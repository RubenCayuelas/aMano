        ...
        <div class="row mb-3">
          <div class="col d-flex flex-sm-nowrap flex-wrap ">
            <div class="profile_picture m-auto m-sm-auto" data-bs-toggle="modal" data-bs-target="#profilePicture">
              <img class="img-fluid rounded-circle w-15rem h-15rem position-absolute" src="../../../assets/img/usersPictures/<?php echo $cliente['foto'] ?>" alt="@<?php echo $cliente['nick'] ?>" style="top: 5.1rem;">
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-12 d-flex mt-3">
                        ...
                        <div class="col-2 d-flex align-items-center justify-content-end">
                          <button type="submit" name="changePicture" value="<?php echo $cliente['foto'] ?>" class="btn btn-sm btn-secondary">Guardar</button>
                        </div>
                      </div>
                    </form>
                  </div>
