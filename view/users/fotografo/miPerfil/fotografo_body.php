<body data-bs-theme=<?php echo $_SESSION['theme'] ?>>
  <!-- Header -->
  <?php include('../../../view/users/fotografo/miPerfil/bodyParts/header.php'); ?>

  <!-- Main -->
  <main class="main w-100 m-0 p-0">
      ...
      <div class="row mb-3">
        <div class="col d-flex flex-sm-nowrap flex-wrap ">
          <div class="profile_picture m-auto m-sm-auto" data-bs-toggle="modal" data-bs-target="#profilePicture">
            <img class="img-fluid rounded-circle w-15rem h-15rem position-absolute" src="../../../assets/img/usersPictures/<?php echo $fotografo[0]['foto'] ?>" alt="@<?php echo $fotografo[0]['nick'] ?>" style="top: 5.1rem;">
      ...
      <div class="row mb-3">
        <div class="d-flex flex-column flex-md-row justify-content-between">
          ...
          <div class="col-md-8 col-12 d-flex align-items-center justify-content-md-end justify-content-center">
            ...
            <form action="#" method="post" class="d-flex align-items-center m-0">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="#" method="post" class="row g-3" enctype="multipart/form-data">
                  <!-- Título -->
                  <div class="col-12">
                    <label for="nombre" class="form_label">Título:<span class="text-danger">*</span> </label>
                    <input type="text" name="nombre" id="nombre" required class="form-control">
                  </div>
                  <!-- Descripción -->
                  <div class="col-12">
                    <label for="descripcion" class="form_label">Descripción:<span class="text-danger">*</span> </label>
